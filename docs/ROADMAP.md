...
- [ ] **P1-2. 환경변수 및 API Key 설정** (복잡도: 낮, 0.5일)
...
- [ ] **P1-3. Thymeleaf 레이아웃 구성** (복잡도: 중, 2일)
...
- [ ] **P1-6. Controller 및 라우팅 기본 구조** (복잡도: 낮, 1일)
...
#### Sprint 2 (Week 3~4): ECOS API 서비스 + 섹션 1~4

- [ ] **P2-1. ECOS API 클라이언트 서비스 구현** (복잡도: 중, 2일)
...
- [ ] **P2-2. 경제지표 데이터 DB 저장 레이어** (복잡도: 중, 2일)
...
- [ ] **P2-4. 섹션2 - GDP/성장률 차트** (복잡도: 중, 1.5일)
...
- [ ] **P2-7. 섹션5 - 무역/경상수지 차트** (복잡도: 중, 1.5일)
...
- [ ] **P2-11. Chart.js 공통 유틸리티 JS** (복잡도: 중, 1일)
...
- [ ] **P3-1. PostgreSQL JPA 엔티티 및 Repository 구현** (복잡도: 중, 2일)
...
- [ ] **P3-2. 서울 아파트 KB 지수 차트** (복잡도: 중, 1.5일)
...
- [ ] **P3-3. 권역별 매매가 월별 통계 차트** (복잡도: 중, 2일)
...
- [ ] **P3-4. 권역별 전세가 월별 통계 차트** (복잡도: 중, 1.5일)
...
#### Sprint 4 (Week 7~8): TOP5 테이블 + UI 통합

- [ ] **P3-5. 올해 매매 TOP5 아파트 테이블** (복잡도: 중, 1.5일)
...
- [ ] **P3-6. 올해 전세 TOP5 아파트 테이블** (복잡도: 중, 1일)
...
- [ ] **P3-7. 권역 탭 UI 및 데이터 연동 통합** (복잡도: 중, 2일)
...
#### Sprint 4 (Week 7~8): 캐시 레이어 + 분석 텍스트

- [ ] **P4-1. 캐시 레이어 구현** (복잡도: 중, 2일)
...
- [ ] **P4-2. Gemini API 클라이언트 서비스** (복잡도: 중, 2일)
...
- [ ] **P4-4. 탭2 부동산 분석 텍스트 생성** (복잡도: 중, 1.5일)
